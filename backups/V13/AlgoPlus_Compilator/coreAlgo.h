...
public:
    ...
    void setValue(Token *value){
        ...
        if(value->Nature() == KeyWord && (toUpper(value->Value()) == "VRAI" || toUpper(value->Value()) == "FAUX"))
...
public:
    FctCall(){}
    FctCall(std::string namefct){this->setName(namefct);}
    ...
    std::string toString(){
        std::string res = "FN " + this->getName() + " (";
