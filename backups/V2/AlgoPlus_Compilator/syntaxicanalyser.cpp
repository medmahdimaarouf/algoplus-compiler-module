...
// + LOCAL KITS
    std::string id_type = "",typeContaint = "";
                                ...
                                else
                                {
                                    if(!IN_Enreg && !IN_Tab && !IN_Mat && !IN_Fich && !IN_Qalifier)
                                    ...
                                    else
                                      {
                                                                ...
                                                                if(t->Nature() == ID)
                                                                {
                                                                    ...
                                                                    try{
                                                                        ...
                                                                        field.nom  = QString::fromStdString(id_Field).toUpper();
                                                                         ...
                                                                         if(f)
                                                                             field.type = f->getType(QString::fromStdString(t->Value()).toUpper());
                                                                         else
                                                                         if(p)
                                                                              field.type = p->getType(QString::fromStdString(t->Value()).toUpper());
                                                                         else
                                                                              field.type = Compilateur::ParseTree->getType(QString::fromStdString(t->Value()).toUpper());
                                            ...
                                            {
                                                Tab:{
                                                        //qDebug()<< "test IN Tab : " << QString::fromStdString(t->Value())<<IN_LI<<IN_InitSizeT<< IN_Punctiation<<IN_size_c<<IN_RI<<IN_DE_Key<<IN_typeContaint<<"\n";
                                                        if(IN_LI)
                                                        {
                                                        ...
                                                        }else
                                                        {
                                                            ...
                                                            {
                                                                try {
                                                                 Array * array = new Array(QString::fromStdString( id_type ).toUpper());
                                                                 array->setSize(size_c);
                                                                 size_c = 0;
                                                                 Type T;
                                                                 if(f)
                                                                     T = f->getType(QString::fromStdString(t->Value()).toUpper());
                                                                 else
                                                                 if(p)
                                                                     T = p->getType(QString::fromStdString(t->Value()).toUpper());
                                                                 else
                                                                     T = Compilateur::ParseTree->getType(QString::fromStdString(t->Value()).toUpper());
                                                    ...
                                                    }else
                                                    {
                                                        ...
                                                        if(t->Nature() == ID)
                                                        {
                                                            try {
                                                             ...
                                                             T.addMemoryRange(memoryRange);
                                                             memoryRange = 0;
                                                             MatrixType * mat = new MatrixType(QString::fromStdString( id_type ));
                                            ...
                                            {
                                                 Fich:{
                                                       //qDebug()<< "fich" << t->Value()<<IN_DE_Key<<IN_typeContaint;
                                                        if(IN_DE_Key)
                                                        {
                                                            if(t->Nature() == ID && toUpper(t->Value()) == "DE")
                                                            {
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            {
                                                                try {
                                                                 FileType * file = new FileType(QString::fromStdString( id_type ).toUpper());
                                                                 Type T;
                                                                 if(f)
                                                                     T = f->getType(QString::fromStdString(t->Value()).toUpper());
                                                                 else
                                                ...
                                                Qalifier:{
                                                    ...
                                                    if(t->Nature() == ID)
                                                    {
                                                        ...
                                                        try{
                                                            Type TQ;
                                                            if(f)
                                                                TQ = f->getType(QString::fromStdString(t->Value()).toUpper());
                                                            else
                                                                if(p)
                                                                    TQ = p->getType(QString::fromStdString(t->Value()).toUpper());
                                                                else
                                                                    TQ = Compilateur::ParseTree->getType(QString::fromStdString(t->Value()).toUpper());
                                                            TQ.addMemoryRange(memoryRange);
                                                            memoryRange = 0;
                                                            QalifierType * QAT = new QalifierType(QString::fromStdString(id_type).toUpper());
